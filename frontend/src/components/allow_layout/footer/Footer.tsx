  ...
  return (
    <footer className=" relative bg-primary text-white rounded-t-[40px] md:rounded-t-[70px] py-8 md:py-14 z-10">
      <div className="max-w-4xl mx-auto px-6 py-6 flex flex-col md:flex-row justify-between">
        <div className="flex flex-col items-left space-y-0 mt-0 mb-5">
          <div className="flex space-x-8 text-2xl mx-auto md:ml-0 mb-2">
            <a href="#" className="hover:text-gray-300"><img src={Instagram} alt="Gestiona Logo" className="w-10 sm:w-14" /></a>
            <a href="#" className="hover:text-gray-300"><img src={Linkdin} alt="Gestiona Logo" className="w-10 sm:w-14" /></a>
          </div>
      ...
      <div className="max-w-4xl space-x-2 mt-0 mx-auto px-6">
        <img src={Logo_footer} alt="Gestiona Logo" className='w-52 md:w-60 mx-auto md:mr-0 md:ml-auto'/>
      </div>
    </footer>
  );
};
